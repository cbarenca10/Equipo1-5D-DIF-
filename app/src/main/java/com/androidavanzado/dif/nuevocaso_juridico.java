...
public class nuevocaso_juridico extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nuevocaso_juridico);
        ...
        NuevoBenef.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                i = new Intent(nuevocaso_juridico.this, nuevobeneficiario.class);
                startActivity(i);
            }
        });
        ...
        casos.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                i = new Intent(nuevocaso_juridico.this, Menu.class);
                startActivity(i);
            }
        });
        ...
        nuevocaso.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                i = new Intent(nuevocaso_juridico.this, nuevocaso.class);
                startActivity(i);
            }
        });
        ...
        seguircaso.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                i = new Intent(nuevocaso_juridico.this, seguircaso.class);
                startActivity(i);
            }
        });
        ...
        salir.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                i = new Intent(nuevocaso_juridico.this, Login.class);
                startActivity(i);
            }
        });
        ...
        llenar_formulario.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                i = new Intent(nuevocaso_juridico.this, juridico_formulario.class);
                startActivity(i);
                registrar_caso();
            }
        });
    ...
    public void registrar_caso() {
        ...
        stringRequest = new StringRequest(Request.Method.POST, URL_SERVIDOR,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if(response.equals("ERROR 1")) {
                            Toast.makeText(nuevocaso_juridico.this, "Se deben de llenar todos los campos.", Toast.LENGTH_SHORT).show();
                            loading.setVisibility(View.GONE);
                            nuevocaso.setVisibility(View.VISIBLE);
                        } else if(response.equals("ERROR 2")) {
                            Toast.makeText(nuevocaso_juridico.this, "Fallo el registro.", Toast.LENGTH_SHORT).show();
                            loading.setVisibility(View.GONE);
                            nuevocaso.setVisibility(View.VISIBLE);
                        } else if(response.equals("MENSAJE")) {
                            Toast.makeText(nuevocaso_juridico.this, "Registro exitoso.", Toast.LENGTH_LONG).show();
                            finish();
                        }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(nuevocaso_juridico.this, "ERROR CON LA CONEXION", Toast.LENGTH_LONG).show();
                loading.setVisibility(View.GONE);
                nuevocaso.setVisibility(View.VISIBLE);
            }
        }){
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(nuevocaso_juridico.this);
